...
{
	class Update extends \System\Object
	{
		protected $_tbl;
		protected $_vals;
		protected $_cond;
		...
		public function Execute($condVars=array())
		{
			...
			$sql="UPDATE ".$db->Delim($this->_tbl,\System\Data\Database::Delim_Table)." SET ";
			$params = array();
			...
			foreach( $this->_vals as $col => $val )
			{
				...
				$sql.=$db->Delim($col,\System\Data\Database::Delim_Column)." = :".preg_replace('/\s/','_',preg_replace('/([^a-zA-Z0-9]*)/','',$col));

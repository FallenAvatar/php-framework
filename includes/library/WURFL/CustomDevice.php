...
class CustomDevice {
	...
	/**
	 * 
	 * @param array Array of \WURFL\Xml\ModelDevice objects
	 * @throws InvalidArgumentException if the $modelDevice is not an array of at least one \WURFL\Xml\ModelDevice
	 */
		...
		if (isset($name)) {
			switch ($name) {
				...
				case "actualDeviceRoot" :
					...
					break;
				default :
					throw new \WURFL\WURFLException("the field " . $name . " is not defined");
					break;
			}
		}
		throw new \WURFL\WURFLException("the field " . $name . " is not defined");

...
class ManagerFactory {
	 ...
	 */
	public function __construct(\WURFL\Configuration\Config $wurflConfig, $persistenceStorage=null) {
	...
	private function init() {
		...
		$context = new \WURFL\Context($this->persistenceStorage);
		...
		$wurflService = new \WURFL\Service($deviceRepository, $userAgentHandlerChain, $cacheProvider);
		
		$requestFactory = new \WURFL\Request\GenericRequestFactory();
		
		$this->wurflManager = new \WURFL\Manager($wurflService, $requestFactory);
	}
	...
	private static function persistenceStorage($persistenceConfig) {
		return \WURFL\Storage\Factory::create($persistenceConfig);
	}
	...
	private static function cacheProvider($cacheConfig) {
		return \WURFL\Storage\Factory::create($cacheConfig);
	}

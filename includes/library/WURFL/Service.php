...
class Service {
	...
	public function __construct(\WURFL\DeviceRepository $deviceRepository, \WURFL\UserAgentHandlerChain $userAgentHandlerChain, \WURFL\Storage $cacheProvider) {
	 ...
	 */
	public function getDeviceForRequest(\WURFL\Request\GenericRequest $request) {
	...
	private function getWrappedDevice($deviceID) {
		...
		return new \WURFL\CustomDevice($modelDevices);
